...
package neoart.unpackers {
  ...
  public final class NoisePacker3 extends Packer {
    ...
    override public function identify(stream:ByteArray):int {
      var b1:int, b2:int, b3:int, higher:int, i:int, length:int, patterns:int, sdata:int, size:int, tdata:int, value:int;
